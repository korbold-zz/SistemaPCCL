                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form id="tabla" method="post" action="<?= site_url() ?>/f019/guardarFormulario">
                                    
                                      <div class="panel panel-green shadow-gris">
                                        <div class="panel-heading"> 
                                            
                                        <div class="panel-body" >
                                            <?php $this->load->view('f019/body'); ?>
                                            <div class="panel-footer">                    
                                                <div class="pull-right">  
                                                    ...
                                                    <a href="<?= site_url() ?>/f019/personas" class="btn btn-default btn-sm">
