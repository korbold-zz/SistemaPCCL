                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <table id="mi_tablita" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>Cédula</th>
                                        ...
                                        foreach ($PERSONAS as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($value->ESTADO == "EV") {
                                                        ?>
                                                        <a href="<?= site_url() ?>/evaluacion_examinador/respuestas_procedimientos/<?= $value->ID_EVALUACION_EXAMINADOR ?>"
                                                           class="btn btn-primary btn-xs">
                                                            <span class="glyphicon glyphicon-check"></span> Revisar</a>
                                                        <?php
                                                    } else if ($value->ESTADO == "RE") {
                                                        ?>
                                                        <a class="btn btn-success btn-xs"
                                                           href="<?= site_url() ?>/reportes/reporte_f015/<?= $value->ID_EVALUACION_EXAMINADOR ?>" 
                                                           target="popup" onClick="window.open(this.href, this.target, 'width=800,height=600');
                                                                            return false;">
                                                            <span class="glyphicon glyphicon-print"></span> Imprimir F015
                                                        </a>
