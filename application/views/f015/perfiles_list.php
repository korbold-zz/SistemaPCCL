                            ...
                            <div class="col-xs-12">
                                ...
                                <table id="mi_tablita"  class="table table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?=$value->ID_PERFIL_PRO_ESTADO?></td>
                                            <td><?=$value->NOMBRE_PERFIL_PRO_ESTADO?></td>
                                            <td>
                                                <a href="<?=site_url()?>/evaluacion_examinador/preguntas_esquemas/<?=$value->ID_PERFIL_PRO_ESTADO?>"
                                                   class="btn btn-primary btn-xs" style="width: 120px">
                                                    <span class="glyphicon glyphicon-edit"></span> Esquemas</a>
                                                <a href="<?=site_url()?>/evaluacion_examinador/preguntas_procedimientos/<?=$value->ID_PERFIL_PRO_ESTADO?>"
                                                   class="btn btn-success btn-xs" style="width: 120px">
                                                    <span class="glyphicon glyphicon-edit"></span> Procedimientos</a>
                                            </td>
                                        </tr>
                                        <?php
                                        }
