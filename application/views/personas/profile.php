...
<body class="no-skin">
    ...
    <div class="main-container ace-save-state" id="main-container">
        ...
        <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
            ...
            <?php $this->load->view('partes/menu_usuario'); ?>
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <?php $this->load->view('personas/registrar'); ?>
                            <?php $this->load->view('personas/calificacion'); ?>
                            <?php $this->load->view('personas/question'); ?>
