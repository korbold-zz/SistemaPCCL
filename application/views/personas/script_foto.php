...
<![endif]-->
		...
		<script src="<?= base_url() ?>ar/assets/js/jquery.hotkeys.index.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/bootstrap-wysiwyg.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/select2.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/spinbox.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/bootstrap-editable.min.js"></script>
							...
							on_error : function(error_type) {//on_error function will be called when the selected file has a problem
								...
								if(error_type == 1) {//file format error
									last_gritter = $.gritter.add({
										title: 'No es Imagen!',
										text: 'Por favor elija jpg|gif|png image!',
