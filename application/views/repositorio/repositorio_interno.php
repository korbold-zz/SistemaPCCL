					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">REPOSITORIO INTERNO</h3>
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='<?= base_url() ?>ar/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
		<script src="<?= base_url() ?>ar/assets/js/bootstrap.min.js"></script>

		<!-- page specific plugin scripts -->
		<script src="<?= base_url() ?>ar/assets/js/jquery.dataTables.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/jquery.dataTables.bootstrap.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/dataTables.buttons.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/buttons.flash.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/buttons.html5.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/buttons.print.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/buttons.colVis.min.js"></script>
		<script src="<?= base_url() ?>ar/assets/js/dataTables.select.min.js"></script>
