...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url() ?>arts/assets/css/bootstrap.min.css" />
        <link rel="stylesheet" href="<?= base_url() ?>arts/assets/font-awesome/4.5.0/css/font-awesome.min.css" />

        <!-- page specific plugin styles -->

        <!-- text fonts -->
        <link rel="stylesheet" href="<?= base_url() ?>arts/assets/css/fonts.googleapis.com.css" />

        <!-- ace styles -->
        <link rel="stylesheet" href="<?= base_url() ?>arts/assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

        <!--[if lte IE 9]>
                <link rel="stylesheet" href="assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
        <![endif]-->
        <link rel="stylesheet" href="<?= base_url() ?>arts/assets/css/ace-skins.min.css" />
        <link rel="stylesheet" href="<?= base_url() ?>arts/assets/css/ace-rtl.min.css" />
        ...
        <script src="<?= base_url() ?>arts/assets/js/ace-extra.min.js"></script>
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
              ...
              <?php
        $this->load->view('partes/menu.php');
        ?>
        ...
        <!--[if !IE]> -->
        <script src="<?= base_url() ?>arts/assets/js/jquery-2.1.4.min.js"></script>
...
<![endif]-->
        <script type="text/javascript">
                    if ('ontouchstart' in document.documentElement)
                        document.write("<script src='<?= base_url() ?>arts/assets/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
        </script>
        <script src="<?= base_url() ?>arts/assets/js/bootstrap.min.js"></script>

        <!-- page specific plugin scripts -->

        <!-- ace scripts -->
        <script src="<?= base_url() ?>arts/assets/js/ace-elements.min.js"></script>
        <script src="<?= base_url() ?>arts/assets/js/ace.min.js"></script>
