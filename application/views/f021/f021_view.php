                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form id="tabla" method="post" action="<?= site_url() ?>/f021/guardar">
                                    
                                      <div class="panel panel-green shadow-gris">
                                        <div class="panel-heading"> 
                                            
                                        <div class="panel-body" >
                                            <?php $this->load->view('f021/body'); ?>
                                            <div class="panel-footer">                    
                                                <div class="pull-right">  
                                                    ...
                                                    <a href="<?= site_url() ?>/f021/personas" class="btn btn-default btn-sm">
   ...
   <script src="<?= base_url() ?>ar/assets/js/ace.min.js"></script>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                        $("#detalles").on("change", "#1,#2,#3,#4,#5,#6,#7,#8,#9", function () {
                            var num1 = parseInt($("#1").val());
                            var num2 = parseInt($("#2").val());
                            var num3 = parseInt($("#3").val());
                            var num4 = parseInt($("#4").val());
                            var num5 = parseInt($("#5").val());
                            var num6 = parseInt($("#6").val());
                            var num7 = parseInt($("#7").val());
                            var num8 = parseInt($("#8").val());
                            var num9 = parseInt($("#9").val());
                            ...
                            if (isNaN(num9)) {
                                ...
                                $("#total").val(num1 + num2 + num3 + num4+ num5+ num6+ num7+ num8+ num9);
